...
// 定义一个冲突检测正则匹配工具
func Regexper(recordfile string, allmatch int, regset ...string) error {
	...
	return exception.ErrRegularMatchFailed("Regular expression matching failed!")
}
